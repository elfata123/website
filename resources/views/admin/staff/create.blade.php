...
@section('content')
    ...
    <div class="card p-4">
        ...
        <form action="{{ route('admin.staff.store') }}" method="POST">
            ...
            @if (isset($counter))
                <a href="{{ route('admin.counters.detail', $counter->id) }}" class="btn btn-secondary ms-1">Kembali</a>
            @else
                <a href="{{ route('admin.staff.index') }}" class="btn btn-secondary ms-1">Kembali</a>
            @endif
